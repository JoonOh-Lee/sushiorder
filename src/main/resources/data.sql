...
INSERT INTO menu (name, description, price, category, image_url, ingredients, allergy_info, stock_count, like_count, dislike_count, is_active, station_id, version, created_at, updated_at) VALUES
    ('온다초밥(10P)', '활어2P+연어양파1P+연어2P+초새우1P+소고기직화1P+계란새우1P+구운새우1P+간장새우1P', 14900, 'TAKEOUT', '/images/menu/pojang_menu.png', '활어, 연어, 새우, 소고기, 계란, 초밥용 밥', '새우, 갑각류, 난류', NULL, 0, 0, true,
     (SELECT id FROM station WHERE name = '뒷주방'), 0, NOW(), NOW()),
    ('온다스페셜초밥(12P)', '활어3P+연어양파1P+연어2P+육회타다끼1P+소고기직화1P+육회초밥1P+구운새우1P+간장새우1P+계란새우1P', 17900, 'TAKEOUT', '/images/menu/pojang_menu.png', '활어, 연어, 새우, 소고기, 육회, 계란, 초밥용 밥', '새우, 갑각류, 난류', NULL, 0, 0, true,
     (SELECT id FROM station WHERE name = '뒷주방'), 0, NOW(), NOW()),
    ('온다패밀리초밥세트(29P+우동(대)+새우튀김)', '활어6P+연어4P+연어양파2P+육회타다끼2P+소고기직화2P+육회초밥2P+구운새우2P+간장새우2P+계란새우2P+유부초밥5P+우동(대)+새우튀김', 39900, 'TAKEOUT', '/images/menu/pojang_menu.png', '활어, 연어, 새우, 소고기, 육회, 계란, 유부, 우동면, 초밥용 밥', '새우, 갑각류, 난류, 밀, 대두', NULL, 0, 0, true,
     (SELECT id FROM station WHERE name = '뒷주방'), 0, NOW(), NOW()),
