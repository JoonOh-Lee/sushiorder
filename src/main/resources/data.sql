...
-- ============================================
INSERT INTO restaurant_table (seat_type, table_number, seat_count, status, x, y, width, height, version, created_at, updated_at) VALUES
    ('COUNTER', 1, 1, 'EMPTY', 5, 91, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 2, 1, 'EMPTY', 5, 82, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 3, 1, 'EMPTY', 5, 73, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 4, 1, 'EMPTY', 5, 64, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 5, 1, 'EMPTY', 5, 55, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 6, 1, 'EMPTY', 5, 46, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 7, 1, 'EMPTY', 5, 37, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 8, 1, 'EMPTY', 5, 28, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 9, 1, 'EMPTY', 5, 19, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 10, 1, 'EMPTY', 5, 10, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 11, 1, 'EMPTY', 80, 10, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 12, 1, 'EMPTY', 80, 19, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 13, 1, 'EMPTY', 80, 28, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 14, 1, 'EMPTY', 80, 37, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 15, 1, 'EMPTY', 80, 46, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 16, 1, 'EMPTY', 80, 55, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 17, 1, 'EMPTY', 80, 64, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 18, 1, 'EMPTY', 80, 73, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 19, 1, 'EMPTY', 80, 82, 15, 5, 0, NOW(), NOW()),
    ('COUNTER', 20, 1, 'EMPTY', 80, 91, 15, 5, 0, NOW(), NOW()),
    ('TABLE', 1, 4, 'EMPTY', 30, 0, 15, 5, 0, NOW(), NOW()),
    ('TABLE', 2, 4, 'EMPTY', 45, 0, 15, 5, 0, NOW(), NOW()),
    ('TABLE', 3, 4, 'EMPTY', 60, 0, 15, 5, 0, NOW(), NOW());
